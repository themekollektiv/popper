...
class popper_recent_posts extends WP_Widget {
	...
	function __construct() {
        $widget_ops = array( 'classname' => 'widget_popper_recent_posts', 'description' => __('Your site&rsquo;s most recent posts with featured image and publishing date.', 'popper') );
        parent::__construct( 'widget_popper_recent_posts', __('Recent Posts','popper'), $widget_ops );
    }
