...
class popper_recent_comments extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Displays recent comments with user avatar and excerpt.', 'popper' )
		);
					...
					<li>
						<a href="<?php echo get_permalink( $comment->comment_post_ID ); ?>#comment-<?php echo $comment->comment_ID; ?>">
							...
							<p class="original-title">
								<span><?php _e( 'on', 'popper' ); ?></span> <?php the_title_attribute( array( 'post' => $comment->comment_post_ID ) ); ?>
							</p>
						</a>
					</li>
